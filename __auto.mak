...
SRC = main.c time.c store.c uart.c terminal.c extlib.c keyboard.c lcd.c twi.c scan_dc.c 
...
CFLAGS =  -std=gnu99 -O0 -gstabs -Wa,-adhlns=$(<:.c=.lst) -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums $(patsubst %,-I%,$(EXTRAINCDIRS)) -Wall -Wshadow -Wsign-compare -Wstrict-prototypes -Wmissing-declarations -Wnested-externs -Wwrite-strings
